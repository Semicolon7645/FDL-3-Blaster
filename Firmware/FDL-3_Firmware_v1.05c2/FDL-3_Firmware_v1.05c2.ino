...
const String versionNumberExtension = "c2";
...
BlastSettings currBlSettings = { 50, 100, 0, 220, 220, 14, 0, 1, 15 };
BlastSettings lastBlSettings = { 50, 100, 0, 220, 220, 14, 0, 1, 15 };
BlastSettings readBlSettings = { 50, 100, 0, 220, 220, 14, 0, 1, 15 };
BlastSettings defBlSettings = { 50, 100, 0, 220, 220, 14, 0, 1, 15 };
...
void setup() {
  ...
  currentAmmoCount = currBlSettings.ammoCountStart;
}
